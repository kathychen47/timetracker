...
T("未来的事件要挂上 future 这个 class", function () {
  ...
  ok(count("var fut=(e.date&&e.date>calToday())") === 1, "判断只该有一处");
...
T("比的是日期字符串，当天不算未来", function () {
  // 真代码里就是 e.date > calToday() 的字符串比较，YYYY-MM-DD 按位比正好等于按时间比
  ok(!("2026-09-10" > "2026-09-10"), "当天不该变淡");
  ok("2026-09-11" > "2026-09-10", "明天该变淡");
  ok(!("2026-09-09" > "2026-09-10"), "昨天不该变淡");
